...
const displayStr = `
    A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} ${totalGames > 1 ? "games" : "game"}. 
    Currently, ${numUnfunded} ${numUnfunded > 1 ? "games" : "game"} remain unfunded. We need your help to fund these amazing games!
`

// create a new DOM element containing the template string and append it to the description container
const divDisplay = document.createElement('div');
divDisplay.innerHTML = `<p>${displayStr}</p>`;
descriptionContainer.append(divDisplay);
...
divFirst.innerHTML = `
    <p>${first.name}</p>
`
firstGameContainer.append(divFirst);
...
divSecond.innerHTML = `
    <p>${second.name}</p>
`
secondGameContainer.append(divSecond);